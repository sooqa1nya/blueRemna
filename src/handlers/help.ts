...
const windows = `[Happ](https://github.com/Happ-proxy/happ-desktop/releases/latest/download/setup-Happ.x64.exe) / [FlClashX](https://github.com/pluralplay/FlClashX/releases/latest) / [Koala Clash](https://github.com/coolcoala/koala-clash/releases/latest) / [Throne](https://github.com/throneproj/Throne/releases/latest) / [v2RayTun](https://v2raytun.com/)`;
